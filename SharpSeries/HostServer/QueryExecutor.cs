...
namespace SharpSeries.HostServer
{
    ...
    public static class QueryExecutor
    {
        ...
        public static void WritePrepareRequest(Memory<byte> buffer, int rpbId, string sql, string statementName, out int length)
        {
            ...
            int extSqlLL = 12 + sqlBytes.Length;
            ...
            int parms = 8;
            length = 40 + stmtNameLL + extSqlLL + 8 + 7 + 7 + pkgLibLL + pkgNameLL + 7;
            ...
            BinaryPrimitives.WriteUInt16BigEndian(buffer.Span.Slice(18, 2), 0x1803);
            ...
            // P1: 0x3806 Statement Name (EBCDIC 37)
            ...
            // P2: 0x3831 Extended SQL Statement Text (CCSID 13488 = UTF-16BE, 4-byte length)
            BinaryPrimitives.WriteUInt32BigEndian(buffer.Span.Slice(offset, 4), (uint)extSqlLL);
            ...
            // P3: 0x3812 SQL Statement Type = 2 (SELECT)
            ...
            BinaryPrimitives.WriteUInt16BigEndian(buffer.Span.Slice(offset+6, 2), 2);
            offset += 8;

            // P4: 0x380A Describe Option = 0xD5
            ...
            // P7: 0x3804 Package Name = "QZDAPKG" (EBCDIC)
            ...
            // P8: 0x3829 Extended Column Descriptor Option = 0xF1
            BinaryPrimitives.WriteUInt32BigEndian(buffer.Span.Slice(offset, 4), 7);
